...
import { LogOut, LayoutDashboard, Package, Boxes, Users, Settings } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="bg-white border-r border-gray-200 w-64 h-screen fixed top-0 left-0 z-10 flex flex-col">
